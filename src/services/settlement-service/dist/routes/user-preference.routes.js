 ...
 */
router.get('/', authenticate, cacheResponse(CACHE_DURATIONS.PREFERENCES), userPreferenceController.getUserPreferences);
/**
 * @swagger
 * /api/preferences:
 *   put:
 ...
 *                   $ref: '#/components/schemas/UserPreference'
 */
router.put('/', authenticate, userPreferenceController.updateUserPreferences);
/**
 * @swagger
 ...
 *                   $ref: '#/components/schemas/UserPreference'
 */
router.patch('/section/:section', authenticate, userPreferenceController.updatePreferenceSection);
/**
 * @swagger
 ...
 *                   $ref: '#/components/schemas/UserPreference'
 */
router.post('/reset', authenticate, userPreferenceController.resetUserPreferences);
/**
 * @swagger
 ...
 *                       type: number
 */
router.get('/notifications', authenticate, cacheResponse(CACHE_DURATIONS.NOTIFICATIONS), userPreferenceController.getNotificationSettings);
/**
 * @swagger
 ...
 *                   $ref: '#/components/schemas/UserPreference'
 */
router.post('/currency', authenticate, userPreferenceController.setDefaultCurrency);
/**
 * @swagger
 ...
 *                   $ref: '#/components/schemas/UserPreference'
 */
router.post('/algorithm', authenticate, userPreferenceController.setSettlementAlgorithm);
module.exports = router;
export {};
//# sourceMappingURL=user-preference.routes.js.map