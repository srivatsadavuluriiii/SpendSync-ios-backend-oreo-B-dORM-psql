...
async function updateUserPreferences(req, res, next) {
  try {
    ...
    const updatedPreferences = await userPreferenceService.updateUserPreferences(
      userId,
      updatedData
    );
...
async function updatePreferenceSection(req, res, next) {
  try {
    ...
    const updatedPreferences = await userPreferenceService.updatePreferenceSection(
      userId,
      section,
      sectionData
    );
