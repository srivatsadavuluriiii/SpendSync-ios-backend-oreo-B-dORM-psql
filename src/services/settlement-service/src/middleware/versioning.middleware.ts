...
export const DEFAULT_VERSION: string = 'v1';
 ...
 */
export const extractVersion = (req: ApiRequest, res: Response, next: NextFunction): void => {
 ...
 */
export const versionRoute = (handlers: VersionHandlers): RequestHandler => {
