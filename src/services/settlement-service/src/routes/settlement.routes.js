...
router.get(
  '/suggestions/:groupId', 
  authenticate, 
  cacheResponse(CACHE_DURATIONS.SUGGESTIONS, generateSuggestionsCacheKey),
  versionRoute(getSettlementSuggestionsHandlers)
);
...
router.get(
  '/group/:groupId', 
  authenticate, 
  cacheResponse(CACHE_DURATIONS.GROUP_SETTLEMENTS, generateGroupCacheKey),
...
router.get(
  '/:settlementId', 
  authenticate, 
  cacheResponse(CACHE_DURATIONS.SETTLEMENT_DETAILS),
...
router.get(
  '/user', 
  authenticate, 
  cacheResponse(CACHE_DURATIONS.USER_SETTLEMENTS),
...
router.get(
  '/compare/:groupId', 
  authenticate, 
  cacheResponse(CACHE_DURATIONS.ALGORITHM_COMPARISON),
  settlementController.compareAlgorithms
);
...
router.get(
  ...
  authenticate,
  cacheResponse(CACHE_DURATIONS.ALGORITHM_COMPARISON),
  settlementController.getSettlementCalculationDetails
);
