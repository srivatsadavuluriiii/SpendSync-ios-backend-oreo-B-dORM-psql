...
export class APIError extends Error {
  ...
  constructor(message: string, statusCode: number, isOperational = true, errorCode: string | null = null) {
    super(message);
...
export class ValidationError extends APIError {
  ...
  constructor(message = 'Validation failed', errors: Record<string, any> = {}, errorCode = 'ERR_VALIDATION') {
...
export class DatabaseError extends APIError {
  ...
  constructor(message = 'Database operation failed', originalError: Error | null = null, errorCode = 'ERR_DATABASE') {
